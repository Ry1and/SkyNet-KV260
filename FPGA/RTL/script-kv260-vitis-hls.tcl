...
create_project [lindex $argv 0] [lindex $argv 1]/[lindex $argv 0]/ -part xck26-sfvc784-2LV-c
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/zynq_ultra_ps_e_0/M_AXI_HPM0_FPD} Slave {/SkyNet_0/s_axi_control} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins SkyNet_0/s_axi_control]
endgroup
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {/zynq_ultra_ps_e_0/pl_clk0 (214 MHz)} Clk_xbar {/zynq_ultra_ps_e_0/pl_clk0 (214 MHz)} Master {/zynq_ultra_ps_e_0/M_AXI_HPM1_FPD} Slave {/SkyNet_0/s_axi_control} intc_ip {/ps8_0_axi_periph} master_apm {0}}  [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
